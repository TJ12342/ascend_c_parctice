...
opc $1 --main_func=pdist --input_param=/home/ma-user/work/TJ111/Pdist/build_out/op_kernel/binary/ascend910b/gen/Pdist_097c0947dbaea0fa5e5d3bccbb38752a_param.json --soc_version=Ascend910B1 --output=$2 --impl_mode="" --simplified_key_mode=0 --op_mode=dynamic
